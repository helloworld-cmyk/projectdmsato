...
Tab **Liên lạc** (`/contact/`) là inbox kiểu Messenger, tổng hợp tất cả phòng chat đội đã được mở sau khi chủ kèo duyệt yêu cầu tham gia.
...
Luồng kiểm tra: vào `/match/` → **Xin vào** → `/profile/` → **Giả lập duyệt** → mở tab **Liên lạc** → chọn phòng chat.
